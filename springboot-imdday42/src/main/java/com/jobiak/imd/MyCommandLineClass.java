...
public class MyCommandLineClass implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		c2.setAcctno(102);c2.setName("Nobitha");c2.setBalance(5000);
		repo.save(c2);
		
		Customer c3 = new Customer();
		c3.setAcctno(103);c3.setName("Deki-suki");c3.setBalance(9000);
		repo.save(c3);
		
		Customer c4 = new Customer();
		c4.setAcctno(104);c4.setName("Sichan");c4.setBalance(7000);
		repo.save(c4);
